  ...
  return (
    <div id="features" className="w-full pt-[80px] pb-[40px]">
      ...
      <div id="featureContainer" className="w-[80%] mx-auto grid grid-cols-12 grid-rows-3 mobiles:grid-cols-6 mobiles:grid-rows-6 gap-10 mobiles:gap-5 pt-16">
        ...
        {/* <div className="w-[80%] m-auto flex mobiles:flex-col mobiles:items-center justify-between py-3">
          <div className=" h-36 w-36 flex flex-col items-center justify-between py-5">
              <div className="bg-[#101010] rounded-2xl p-[18px]">
                <PiUsersThree className=" text-[30px] text-[#6353ff]" />
              </div>
              <p className="text-[14px] text-[#eaeaea] font-medium">Team Sync</p>
          </div>
          <div className=" h-36 w-36 flex flex-col items-center justify-between py-5">
              <div className="bg-[#101010] rounded-2xl p-[18px]">
                <PiLock className=" text-[30px] text-[#6353ff]" />
              </div>
              <p className="text-[14px] text-[#eaeaea] font-medium">256-Bit Encryption</p>
          </div>
          <div className=" h-36 w-36 flex flex-col items-center justify-between py-5">
              <div className="bg-[#101010] rounded-2xl p-[18px]">
                <PiChartDonut className=" text-[30px] text-[#6353ff]" />
              </div>
              <p className="text-[14px] text-[#eaeaea] font-medium">Custom Dashboards</p>
          </div>
          <div className=" h-36 w-36 flex flex-col items-center justify-between py-5">
              <div className="bg-[#101010] rounded-2xl p-[18px]">
                <PiTimer className=" text-[30px] text-[#6353ff]" />
              </div>
              <p className="text-[14px] text-[#eaeaea] font-medium">Session Tracking</p>
          </div>
          <div className="h-36 w-36 flex flex-col items-center justify-between py-5">
              <div className="bg-[#101010] rounded-2xl p-[18px]">
                <PiChat className=" text-[30px] text-[#6353ff]" />
              </div>
              <p className="text-[14px] text-[#eaeaea] font-medium">24x7 Support</p>
          </div>
        ...
        {/* <div className="w-[80%] m-auto flex mobiles:flex-col mobiles:items-center justify-between py-3 ">
          <div className=" h-36 w-36 flex flex-col items-center justify-between py-5">
              <div className="bg-[#101010] rounded-2xl p-[18px]">
                <PiIntersect className=" text-[30px] text-[#6353ff]" />
              </div>
              <p className="text-[14px] text-[#eaeaea] font-medium">Cross-Tracking</p>
          </div>
          <div className=" h-36 w-36 flex flex-col items-center justify-between py-5">
              <div className="bg-[#101010] rounded-2xl p-[18px]">
                <PiLightning className=" text-[30px] text-[#6353ff]" />
              </div>
              <p className="text-[14px] text-[#eaeaea] font-medium">Rapid Analysis</p>
          </div>
          <div className=" h-36 w-36 flex flex-col items-center justify-between py-5">
              <div className="bg-[#101010] rounded-2xl p-[18px]">
                <PiCertificate className=" text-[30px] text-[#6353ff]" />
              </div>
              <p className="text-[14px] text-[#eaeaea] font-medium">SOC3 Certified</p>
          </div>
          <div className=" h-36 w-36 flex flex-col items-center justify-between py-5">
              <div className="bg-[#101010] rounded-2xl p-[18px]">
                <PiNotification className=" text-[30px] text-[#6353ff]" />
              </div>
              <p className="text-[14px] text-[#eaeaea] font-medium">Dynamic Updates</p>
          </div>
          <div className="h-36 w-36 flex flex-col items-center justify-between py-5">
              <div className="bg-[#101010] rounded-2xl p-[18px]">
                <PiDownload className=" text-[30px] text-[#6353ff]" />
              </div>
              <p className="text-[14px] text-[#eaeaea] font-medium">Download Reports</p>
          </div>
