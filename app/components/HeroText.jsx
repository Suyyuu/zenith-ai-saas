  ...
  return (
    <>
      <div className="center w-[100%] h-full flex flex-col items-center gap-4 pt-[180px] mobiles:pt-32 pb-9 mobiles:pb-0">
          ...
          <motion.button className='text-[#8a8a8a] text-[14px] font-semibold px-5 py-2 rounded-full flex items-center gap-3 btnHoverEffect font-host-grotesk tracking-tight shadow-[0_0_0_1px_rgba(235,235,235,0.15)]'
          ...
          <div className="heroText mobiles:w-[70%] mobiles:text-center flex flex-col items-center">
            ...
            <p className='font-Satoshi font-normal text-center tabPlus:text-lg text-[14px] text-[#ebebebcc]'> A single platform for project management, team collaboration, product analysis, and scaling</p>
            </BlurReveal>
            ...
            >
              ...
              <Link href="#about" className=' button group bg-[#5653ff] text-base mobiles:text-[14px] font-Satoshi font-medium px-10 py-3 rounded-full text-[#dadada] before:bg-[#f4f4f4] flex items-center'>
              ...
              <Link href="/pricing" className=' button group outline outline-[.1px] outline-[#8a8a8a] text-base mobiles:text-[14px] font-Satoshi font-medium px-10 mobiles:px-9 py-3 rounded-full text-[#dadada] before:bg-[#f4f4f4] flex items-center'>
                <span className="transition-transform transform group-hover:-translate-x-3 duration-500">
                  Try It Free
                </span>
